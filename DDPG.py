...
class Robot(object):
    ...
    def get_reward(self):
        #
        # if self.tip_target_dis > 500:
        #     r = - 20
        # elif self.tip_target_dis > 350:
        #     r = - 15
        #     # r = 1/(-((self.tip_target_dis/1000)**2+1e-8))
        # elif self.tip_target_dis > 200:
        #     r = - 10
        #
        # elif self.tip_target_dis > 50:
        #     r = - 5
        #
        # elif self.tip_target_dis > 2:
        #     r = 0
        #
        # else:
        #
        ...
        # r = 1/((self.tip_target_dis - 300 + 1)**.2 + 1e-6) - 1
        r = 1 / ((self.tip_target_dis / 1000) ** 2 + 1e-8)
        print('tip_target_dis', self.tip_target_dis)

        w.observe(event_name='tip_target_dis', tip_target_dis=self.tip_target_dis, r=r)
...
def train():
    ...
    for ep in range(MAX_EPISODES):
        ...
        for t in range(MAX_EP_STEPS):
            ...
            print(dict(action_chocie=a, generated_reward=r, state_chosen=s))
            # if r > 10:
